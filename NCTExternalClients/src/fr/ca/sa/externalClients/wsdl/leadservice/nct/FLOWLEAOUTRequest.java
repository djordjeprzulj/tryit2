...
public class FLOWLEAOUTRequest {
    ...
    protected List<FLOWLEAOUTRequest.FLOWLEAOUT> flowleaout;
     ...
     * 
     */
    public List<FLOWLEAOUTRequest.FLOWLEAOUT> getFLOWLEAOUT() {
        if (flowleaout == null) {
            flowleaout = new ArrayList<FLOWLEAOUTRequest.FLOWLEAOUT>();
        }

 ...
 *
 */
public class GetOpportunityDataMyTasksRsp implements Serializable {
	 ...
	 */
	public GetOpportunityDataMyTasksRsp() {
		super();
	}
	 ...
	 * 				Opportunities
	 */
	public GetOpportunityDataMyTasksRsp(List<GetOpportunityDataNCTResultItem> opportunities) {
		super();

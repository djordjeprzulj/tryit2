 ...
 *
 */
public class SimpleCodeTableInsertResponse implements Serializable {
	...
	/**
	 * default constructor for Simple CodeTable Insert Response
	 */
	public SimpleCodeTableInsertResponse() {
		super();
	}

	/**
	 * Simple CodeTable Insert Response
	 * 
	 * @param codeTableName
	 * 				Code table name
	 * 
	 ...
	 * 				Active
	 */
	public SimpleCodeTableInsertResponse(String codeTableName, int id, String nameL1, String nameL2, boolean active) {
		super();

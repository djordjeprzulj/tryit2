 ...
 *
 */
public class StringAuditCodeTableUpdateRequest implements Serializable {
	...
	/**
	 * default constructor for String Audit CodeTable Update Request
	 */
	public StringAuditCodeTableUpdateRequest() {
		super();
	}

	/**
	 * String Audit CodeTable Update Request
	 * 
	 * @param stringId
	 * 				String ID
	 * 
	 ...
	 * 				If it's active
	 */
	public StringAuditCodeTableUpdateRequest(int stringId, String paramValueL1, String paramValueL2, boolean active) {
		super();
	...
	public String toString() {
		return "StringAuditCodeTableUpdateRequest [stringId=" + stringId + ", paramValueL1=" + paramValueL1

 ...
 *
 */
public class TreatedReasonCodeTableUpdateRequest implements Serializable {
	...
	/**
	 * default constructor for Treated Reason CodeTable Update Request
	 */
	public TreatedReasonCodeTableUpdateRequest() {
		super();
	}

	/**
	 * Treated Reason CodeTable Update Request
	 * 
	 ...
	 * 				If it's active
	 */
	public TreatedReasonCodeTableUpdateRequest(int oppSubCategoryId, String nameL1, String nameL2, Integer reasonOrder, boolean active) {
		super();
	...
	public String toString() {
		return "TreatedReasonCodeTableUpdateRequest [reasonId=" + reasonId + ", oppSubCategoryId=" + oppSubCategoryId

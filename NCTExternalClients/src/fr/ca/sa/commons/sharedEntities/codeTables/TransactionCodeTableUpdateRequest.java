 ...
 *
 */
public class TransactionCodeTableUpdateRequest implements Serializable {
	...
	/**
	 * default constructor for Transaction CodeTable Update Request
	 */
	public TransactionCodeTableUpdateRequest() {
		super();
	}

	/**
	 * Transaction CodeTable Update Request
	 * 
	 ...
	 * 				If it's active
	 */
	public TransactionCodeTableUpdateRequest(int transactionCode, String transactionNameL1, String transactionNameL2,
			boolean active) {
		super();
	...
	public String toString() {
		return "TransactionCodeTableUpdateRequest [transactionCode=" + transactionCode + ", transactionNameL1="
